...
public String registrarClientePost(@RequestParam String nombre, @RequestParam String apellido, @RequestParam String localidad, @RequestParam String direccion, @RequestParam String barrio, @RequestParam String telefono, @RequestParam String email, @RequestParam String password, @RequestParam String password2, ModelMap modelo, @RequestParam byte[] imagen) throws Exception {
...
public String registrarClienteProveedorPost(@PathVariable String id,@RequestParam Integer dni, @RequestParam Integer experiencia, @RequestParam String descripcion, @RequestParam List<String> serviciosIds, ModelMap modelo) {
